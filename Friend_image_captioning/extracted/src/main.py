...
from src.config import MODEL_BEST_PATH, MODEL_LATEST_PATH, TOKENIZER_PATH, TRAINING_LOG_PATH, VAL_IMAGES, device
...
def run_expand_vocab(new_data_path):
    ...
    from src.config import CLIP_TEXT_MODEL, EMBED_SIZE, HIDDEN_SIZE, NUM_HEADS, NUM_LAYERS
...
if __name__ == "__main__":
    ...
    if args.command == "menu":
        ...
        from src.setup import setup_vocab
        setup_vocab()
        ...
        from src.setup import setup_imagenet
        setup_imagenet()
